...
import com.Blue.photorecovery.databinding.DeleteItemDialogBinding
import com.daimajia.androidanimations.library.Techniques
import com.daimajia.androidanimations.library.YoYo

class DeleteItemDialogFragment(val decision: (decision: Boolean) -> Unit) :
    DialogFragment(),
    View.OnClickListener {
    private lateinit var display: DeleteItemDialogBinding
    ...
    override fun onCreateView(
        ...
        display = DeleteItemDialogBinding.inflate(layoutInflater)
        return display.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        display.apply {
            btnOk.setOnClickListener(this@DeleteItemDialogFragment)
            btnNo.setOnClickListener(this@DeleteItemDialogFragment)
            setGradientOnlyOnEasyRecovery(btnNo)
            deleteCount. setTextSize(TypedValue.COMPLEX_UNIT_PX, 60f)
            textContent.setTextSize(TypedValue.COMPLEX_UNIT_PX, 40f)
